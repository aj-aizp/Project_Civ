...
/*
Machine Gunner Death script. Just handles the death kickback when Unit Dies. Also keeps up with the health of the Unit.
*/
public class MachineGunner_AI : MonoBehaviour
{
    ...
    //Makes sure to disable most of the components on the object to stop animation or collision bugs.
    private void Death()
    {
    ...
    //Death vector is given from the bullet that killed the unit. Stored from damage vector.
