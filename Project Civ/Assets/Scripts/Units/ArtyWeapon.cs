...
/*
Handles Artillery AI and health. Here is where the fire method and death method are for the Artillery.
*/
public class ArtyWeapon : MonoBehaviour
{
    ...
    [SerializeField]
    AudioClip mortarShot;

    [SerializeField]
    UnionSol union;

    [SerializeField]
    ArtyTarget targetSystem;
    ...
    //Fire() coroutine. Animation and sound is also played here.
    ...
    //When hit with enemy bullet, subtract from total health
